...
func startFinanceServer() error {
	...
	cmd := exec.Command(pythonCmd, "./internal/python/finance_data_manager.py")
...
func main() {
	financeServerFlag := flag.Bool("finance-server", true, "Enable or disable the finance server")
	flag.Parse()
